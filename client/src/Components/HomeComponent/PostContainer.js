...
const PostContainer = (props) => {
    ...
    var postData = [
        ...
        },
        {
            ...
            "title": "Huong dan lap trinh Java",
            "content": "Khi bắt đầu học lập trình, có rất nhiều ngôn ngữ để lựa chọn.",
            "upVote": 0,
            "commentCount": 0,
            "shareCount": 0
        },
    ...
    return (
        <div className="PostContainer">
            {(postData.length > 0) && postData.map((post) => <PostShort key={post.id} post={post}/>)}
        </div>
    )
}
